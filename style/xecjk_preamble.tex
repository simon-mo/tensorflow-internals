...
%% 设置缺省中文字体
\setCJKmainfont[BoldFont={STHeiti}, ItalicFont={STHeiti}]{STHeiti}   %  FZBaoSongZ04
%\setCJKmainfont[BoldFont={STHeiti}, ItalicFont={STHeiti}]{STHeiti}   %  FZBaoSongZ04

%% 设置中文无衬线字体
\setCJKsansfont[BoldFont={STHeiti}, ItalicFont={STHeiti}]{STHeiti}
%\setCJKsansfont[BoldFont={STHeiti}, ItalicFont={STHeiti}]{STHeiti}
%% 设置等宽字体
...
%% 定义新字体
\setCJKfamilyfont{song}{STHeiti}
\setCJKfamilyfont{kai}{STHeiti}
\setCJKfamilyfont{hei}{STHeiti}
\setCJKfamilyfont{fangsong}{STHeiti}
\setCJKfamilyfont{lisu}{LiShu}
\setCJKfamilyfont{youyuan}{STHeiti}
